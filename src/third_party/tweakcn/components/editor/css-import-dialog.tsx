...
const CssImportDialog: React.FC<CssImportDialogProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex max-h-[90dvh] flex-col overflow-hidden shadow-lg sm:max-h-[min(640px,80dvh)] sm:max-w-[550px] sm:pt-6">
        <ScrollArea className="flex h-full flex-col">
          <div className="space-y-6 pb-2">
            <DialogHeader className="px-6">
              <DialogTitle>Import Custom CSS</DialogTitle>
              <DialogDescription>
                Paste your CSS file below to customize the theme colors. Make
                sure to include variables like --primary, --background, etc.
              </DialogDescription>
            </DialogHeader>
...
.dark {
  ...
  /* And more */
        ...
        <DialogFooter className="bg-muted/30 mt-4 border-t px-6 py-4 sm:mt-0">
          <Button
            variant="ghost"
            onClick={handleClose}
            size="sm"
